        ...
        <section className="bg-gray-50 py-16 px-6" dir="rtl">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-bold text-[#1A237E] mb-4">خريجوا الكتاب</h2>
                    <div className="w-24 h-1 bg-[#1A237E] mx-auto rounded-full mb-6"></div>
                    <p className="text-gray-600 max-w-2xl mx-auto">نفتخر بطلابنا الذين أتموا حفظ القرآن الكريم</p>
                </div>
